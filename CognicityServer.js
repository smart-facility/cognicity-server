	      ...
	      "FROM (SELECT 'Feature' as type, " +
	        ...
	        "FROM (SELECT " +
	         "m.location, m.id, m.height_above_riverbed, " +
	          "array_to_json(array_agg((obs.measurement_time AT TIME ZONE 'ICT', obs.distance, m.height_above_riverbed - obs.distance, obs.temperature, obs.humidity)::sensor_data_type ORDER BY obs.measurement_time ASC)) as " +
	          "measurements " +
	            "FROM " +
