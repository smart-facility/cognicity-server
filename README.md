...
Travis build status: [![Travis Build Status](https://travis-ci.org/smart-facility/cognicity-server.svg?branch=2.0.x)](https://travis-ci.org/smart-facility/cognicity-server)
